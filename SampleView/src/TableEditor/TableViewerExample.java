...
//	 Set column names
	 ...
	 * @param parent
	 */
	public TableViewerExample(Composite parent,int type,Object obj) {
		this.type=type;
		this.obj=obj;
		this.addChildControls(parent);
		/*if(type==1)
		{
			// no properties for project
		}
		else if(type==2)
		{
		...
		{
			//no properties for UISet now
		}
		else if(type==5)
		{
			//no properties for UIView now
		}
		else if(type==6)
		{
			columnNames=new String[] { 
	...
	/*public static void main(String[] args) {
		...
		final TableViewerExample tableViewerExample = new TableViewerExample(composite,1,new Object());
